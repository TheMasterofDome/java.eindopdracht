...
public class Controller implements IController {
	...
	/**
	 * Laat het model weer vanaf het begin beginnen: Kavels terug naar
	 * origineel, boswachters weg, update-counter weer naar 0. Pauzeer de timer
	 * tijdens de reset om te voorkomen dat er ongelukken gebeuren als nog niet
	 * het hele veld gereset is maar het veld wel weer geupdate wordt,
	 * bijvoorbeeld.
	 */
