...
public class View implements IView, ComponentListener {
	 ...
	 * Ook stelt hij het midden in en initialiseert hij de rest van de variabelen.
	 * @param controller die deze view en het bijbehorende model bestuurt
	 */
	...
	private void createUI() {
		...
		// voeg deze klasse zelf toe als componentlistener, wordt alleen gebruikt voor resizen van het frame
		...
		// maak de reset-knop en roep de methode doeReset() aan als op deze knop wordt gedrukt
		// TO DO: zorgen dat "reset" doeReset aanroept en dat "Simuleer" doeSimuleer aanroept.
		// nu: bij Simuleer gebeurt niks, bij Reset worden ze allebei aangeroepen.
		...
		// maak de simulate-knop en roep de methode doeSimuleer() aan als op deze knop wordt gedrukt.
		...
		MouseListener muis = new MouseListener() {
			...
			//Deze submethode stelt het coordinaat in waar de muis is als je bgint met slepen (klikken).
			public void mousePressed(MouseEvent e) {
				start_end_coords[2] = e.getX();
				start_end_coords[3] = e.getY();
			}
			//Deze submethode stelt het coordinaat in waar de muis is als je ophoudt met slepen.
		...
		//Dit object en submethode zetten moving op true als de muis aan het slepen is.
	...
	/**
	 * De methode die het veld op de nieuwe positie afbeeldt.
	 * Dit door de verplaatsing te berekenen, dit aan het startpunt te geven en opnieuw af te beelden.
	 * @param i een array van integers die de coordinaten voorstellen startX, startY, eindX, eindY.
	 */
